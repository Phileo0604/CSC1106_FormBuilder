...
<form action="/trade/create" method="post">
    ...
    <select name="stock" id="stock" value ="<?= esc($trade['stock']) ?>">
    ...
    <input type="input" name="noofshares" value="<?= esc($trade['noofshares']) ?>">

    <label for="marketprice">Market Price: </label>
    <input type="number" name="marketprice" value="<?= esc($trade['marketprice']) ?>">
    <br>

    <select name="action" id="action" value="<?= esc($trade['action']) ?>">
    <label for="Action">Action</label>
    <option value="buy" name = 'buy'>Buy</option>
    <option value="sell" name = 'sell'>sell</option>
    </select>

    <select name="type" id="type" value = "<?= esc($trade['type']) ?>">
